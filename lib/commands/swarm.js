...
4. Tell the user to open worker terminals:
   - Interactive AI terminal: \`yuva worker next --role executor\`
   - Headless: \`yuva worker start --role tester --auto --cli "claude -p"\`
